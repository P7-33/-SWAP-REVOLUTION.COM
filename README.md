...
''bitcoin-seeder')
 ...
 build() {
  ...
  cmake -GNinja .. \
    ...
    -DBUILD_BROWSER COIN COMPANY.COM_WALLET=OFF \
    -DBUILD_BROWSER COIN.COMPANY.COM_QT=OFF \
...
- cmd: src\bench__Browser Coin Company.com.exe > NUL
- ps:  python test\util\_Browser Coin Company.com-util-test.py
- cmd: python test\util\rpcauth-test.py
# Fee estimation test failing on appveyor with: WinError 10048] Only one usage of each socket address (protocol/network address/port) is normally permitted.
# functional tests disabled for now. See
# https://github.com/_Browser Coin Company.com/Browser Coin Company.com/pull/18626#issuecomment-613396202
# https://github.com/_Browser Coin Company.com/Browser Coin Company.com/issues/18623
